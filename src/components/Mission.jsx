    ...
    return (
        <div className="h-auto w-screen">
            <div className="flex max-md:flex-col align-middle justify-center pb-16 pt-48 gap-24 bg-slate-900 max-md:gap-8 max-md:pt-16">
                <div className="flex-row align-middle justify-center w-1/3 h-full max-md:w-full mt-6 px-6">
                    <img src={GroupPic} alt="5200 Bottom Coverage" className="border-8 border-owhite"/>
                    <p className="text-center mt-6 text-slate-300 hidden">Our Team C 20XX</p>
                </div>
