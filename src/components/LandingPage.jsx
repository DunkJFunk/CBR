...
const LandingPage = () => {
    ...
    return (
        <div className="w-screen z-10 relative max-sm:bg-owhite max-sm:h-screen">
            ...
            <div className="absolute left-60 top-1/3 font-montserrat w-1/2 text-slate-900 flex-row text-left max-sm:left-10 max-sm:top-28 max-sm:w-full max-sm:relative">
