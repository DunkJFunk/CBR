...
const Contact = () => {
    ...
    return (
        <div className="relative">
            <div className="py-20 lg:py-16 px-4 mx-auto max-w-screen-md scroll-m-24 relative" id="contact">
                ...
                <div className="grid grid-cols-2 justify-center align-middle gap-12">
                    <div className="font-light text-right">
                        ...
                        <p className="mb-2 lg:mb-16 font-light text-gray-500 dark:text-gray-400 sm:text-xl">thecbrshop@gmail.com</p>
                    </div>
            ...
            <Link to="/admin">
                <FontAwesomeIcon onClick={loginWithRedirect} icon={faGear} className="h-8 text-owhite absolute top-5 right-5"/>
            </Link>
        </div>
    )
};
